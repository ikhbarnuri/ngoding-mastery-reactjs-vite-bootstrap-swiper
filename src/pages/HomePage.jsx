            ...
            <header className="w-100 min-vh-100 overflow-hidden">
                <Container>
                    <Row className="header-box d-flex align-items-center pt-lg-5">
                        <Col lg={6}>
                            <h1 className="mb-4 animate__animated animate__fadeInUp">Temukan <br/>
                                <span>Bakat Kreatifmu</span> <br/> Bersama Kami!</h1>
                            <p className="mb-4 animate__animated animate__fadeInUp">Lorem ipsum dolor sit amet,
                                consectetur adipisicing elit. Aut doloribus
                                fuga
                                necessitatibus
                            ...
                            <button
                                className="btn btn-outline-danger btn-lg rounded-1 mb-xs-0 mb-2 animate__animated animate__fadeInUp">Lihat
                                Promo
                            </button>
                        </Col>
                        <Col lg={6}>
